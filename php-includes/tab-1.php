...
<input id=name placeholder="Your Name" required a><span class=required>*</span><br/>
<span id=nameError></span><br/>
<label for=e><span class=emailSymbol>@</span></label>
<input type=email id=e placeholder="Your Email" required a><span class=required>*</span><br/>
<span id=emailError></span><br/>
<label for=subject> Subject:</label>
<input id=subject placeholder="Your Subject" required><span class=required>*</span><br/>
<span id=subjectError></span><br/>
<label for=msg>Message:</label>
<textarea id=msg placeholder="Your message here..." required cols=40 rows=6></textarea><span class=required>*</span><br/>
...
<input type=hidden name=csrf_token value=c52f003a6a19c661e2779983b87dc8fc></form>
</div>
</div> 